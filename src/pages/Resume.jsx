    ...
    <main>
      ...
      <div className={styles.left}>
        ...
        <section>
          ...
          <ul>
            ...
            <li> Providing Custom Solutions in web development to clients.</li>
            <li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Designed the Layout, Logo and illustrations using Figma and Canva
            </li>
            <li>Provided valuable insights on product placement and display</li>
          </ul>
        </section>
        <section>
          <h3>AcrossMe</h3>
          ...
          <ul>
            ...
            <li>
              Implemented top deals section with auto delete from database after
              expiration
            </li>
            <li>
              Used react and firebase to give Auth, User customizations and CRUD
              admin features to customer
            </li>
      ...
      <div className={styles.right}>
        <section className={styles.contact}>
          ...
          <li> Ghaziabad, U.P.</li>
          <li> +91-8287716284</li>
          <li> Ujjwalsharma.6792@gmail.com</li>
          <li> https://ujjwalsharma.live</li>
          <li> https://github.com/ujjwal6792</li>
        </section>
        <section>
          <h2>SKILLS</h2>
          <li> ReactJs/Redux</li>
